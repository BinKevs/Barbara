...
function Landing() {
  return (
    <>
      <div className=" md:mt-[88px] mt-[82px] bg-[#FEFCF0] lg:h-screen flex">
      ...
      <div className=" bg-black">
        <div className="text-white w-[95%] mx-auto py-20">
          <div className="lg:text-7xl md:text-5xl text-4xl flex  justify-between pb-4 md:w-[80%] mx-auto">
            <div className="my-auto">Barbara Tieken</div>
          ...
          <div className="">
            <div className="md:text-3xl sm:text-2xl text-lg flex flex-col text-justify md:w-[50%] w-[70%] mx-auto">
              <div className="">
                ...
                who fly, be it bird or spirit.” An avid environmentalist,
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-[70%] mx-auto ">
          <div>
            ...
            <div className="text-black text-lg lg:w-[50%] w-[80%]">
              ...
              society's symbol of strength and rebirth.
              <Link to="reviews" className="text-xl my-4 text-[#753536] flex">
                Read More{" "}
          ...
          <div>
            ...
            <div className="text-black font-light text-lg lg:w-[50%] w-[80%] ">
              ...
              providing readers a rich and riveting narrative.
              <Link to="reviews" className="text-xl text-[#753536] flex">
                Read More{" "}
                <IconContext.Provider value={{ size: "1.8em" }}>
                  <AiOutlineRight />
                </IconContext.Provider>
